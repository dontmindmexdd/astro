...
require("lazy").setup({
  spec = {
    ...
    { import = "lazyvim.plugins.extras.lang.python" },          -- yaml
    ...
    { import = "lazyvim.plugins.extras.vscode" },               -- vscode neovim plugin

    { import = "lazyvim.plugins.extras.util.startuptime" },     -- start up time

    { import = "lazyvim.plugins.extras.coding.luasnip" },       -- lua snippets
    { import = "lazyvim.plugins.extras.coding.mini-surround" }, -- brackets surround

    { import = "lazyvim.plugins.extras.editor.illuminate" },    -- usage highlighting
  },
  defaults = {
